...
const Cases = ({ lastDayData, regionName }) => {
  ...
  return (
    <div className='p-4 text-center col-span-12 lg:col-span-7 lg:col-start-4 border-2 border-primary/50  bg-ternary/50 dark:bg-dark-primary/50 dark:border-dark-ternary/50 rounded-md '>
